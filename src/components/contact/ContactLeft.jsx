...
const ContactLeft = () => {
  return (
    <div
     className="w-full sm:w-[45%] md:w-[45%] lg:w-[35%]  h-full bg-gradient-to-r from-[#1e2024] 
     to-[#23272b] shadow-shadowOne p-2 rounded-lg  flex flex-col gap-4 justify-center "
    >
      <img 
